...
public class ParseGame2024 : MonoBehaviour {
...
//				Debug.Log (teamName);
	...
	private void populateTeamArrays()
	{
		...
		teamNamesFull = new string[]{"Arizona Cardinals " , "Atlanta Falcons " , "Baltimore Ravens " , "Buffalo Bills " , "Carolina Panthers " , "Chicago Bears " , "Cincinnati Bengals " , "Cleveland Browns " , "Dallas Cowboys " , "Denver Broncos " , "Detroit Lions " , "Green Bay Packers " ,
			...
			"Philadelphia Eagles " , "Pittsburgh Steelers " , "Los Angeles Chargers " , "Seattle Seahawks " , "San Francisco 49ers " , "Tampa Bay Buccaneers " , "Tennessee Titans " , "Washington Football Team "} ;

		teamIcons = new string[]{":cardinals:" , ":falcons:" , ":ravens:" , ":bills:" , ":panthers:" , ":bears:" , ":bengals:" , ":browns:" , ":cowboys:" , ":broncos:" , ":fibur:" , ":packers:" , ":texans:" , ":colts:" , ":jaguars:" , ":chiefs:" , ":rams:", ":dolphins:" , ":vikings:" , ":patriots:" , ":saints:" , ":giants:" , ":jets:" , ":raiders:" , ":eagles:" , ":steelers:" , ":chargers:" , ":seahawks:" , ":49ers:" , ":buccaneers:" , ":titans:" , ":wft:"};
