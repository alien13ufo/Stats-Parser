...
public class ParseGame2021 : MonoBehaviour {
...
//		Debug.Log ("TEAM STATS DONE");
	...
	public void sendToDB(string tableName)
	{
		...
		NpgsqlConnection conn = new NpgsqlConnection("Server=127.0.0.1;Port=5432;User Id=postgres;Password=mighty;Database=2022 NFL Stats;");
